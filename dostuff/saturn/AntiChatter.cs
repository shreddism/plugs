...
namespace UnterpTabletDriverFilters.Devocub
{
    ...
    public class Antichatter : MillimeterPositionedPipelineElement
    {
        ...
        [SliderProperty("Latency", 0f, 1000f, 0f), DefaultPropertyValue(0f), ToolTip(LATENCY_TOOLTIP)]
        ...
        [Property("Distance Multiplier"), DefaultPropertyValue(1.0f), ToolTip
        (
        ...
        public override void Consume(IDeviceReport State)
        {
            if (State is ITabletReport report)
            {
                ...
                if (expectC > 0f) {
                    timeMult = Math.Min(1f, consumeTime / expectC);
                }
