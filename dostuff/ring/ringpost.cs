...
{
    [PluginName("ringpost")]
    public class ringpost : IPositionedPipelineElement<IDeviceReport>
    {
        public ringpost() : base()
        {
        }
       ...
       public event Action<IDeviceReport> Emit;
        ...
        public void Consume(IDeviceReport value)
        {
            if (value is ITabletReport report)
            {
                ...
                if (ringDir.Length() > 0)
                outputPos0 = capDist(outputPos0, Vector2.Lerp(outputPos0, pos0, 0.1f), 0.1f);
